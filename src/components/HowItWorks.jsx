...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Select a variant, choose an available slot, and pay the advance amount securely online.',
    ...
    },
    {
      icon: FaPaw,
      title: 'Visit Clinic',
      description: 'Visit the clinic at your confirmed slot and complete the service with our veterinary team.',
