...
const Footer = () => {
  return (
    <>
      <div className="w-full h-[400px] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 opacity-0 animate-[fadeIn_0.8s_ease-out_forwards]">
        <iframe
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-8 md:pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="opacity-0 animate-[fadeIn_0.6s_ease-out_0.1s_forwards]">
              <div className="flex items-center gap-3 mb-4">
                <img src="/logo.jpg" alt="Kings Pet Hospital" className="h-10 w-10 rounded-md shadow-md ring-2 ring-white/10" />
                <h2 className="text-2xl font-bold text-blue-400">Kings Pet Hospital</h2>
              </div>
              <p className="text-gray-400 mb-4">
                Providing exceptional care for your beloved pets since 2019.
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(59,130,246,0.6)]"
              ...
              <ul className="space-y-2">
                {quickLinks.map((link) => (
                  <li key={link.title}>
                    ...
                    >
                      <svg
                        className="w-4 h-4 mr-2 text-blue-500 transform transition-transform duration-300 group-hover:translate-x-1"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
            ...
            <div className="opacity-0 animate-[fadeIn_0.6s_ease-out_0.3s_forwards]">
              ...
              <ul className="space-y-2">
                {services.map((service) => (
                  <li key={service} className="flex items-center text-gray-400">
                    <svg
            ...
            <div className="opacity-0 animate-[fadeIn_0.6s_ease-out_0.4s_forwards]">
              ...
              <div className="space-y-4">
                {contactInfo.map((info) => (
                  <p key={info.text} className="flex items-start text-gray-400 group">
                    <span className="mr-2 text-blue-400 transform transition-transform duration-300 group-hover:scale-110">
                      {info.type === 'address' && (
          ...
          <div className="border-t border-gray-800 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center gap-3 mb-4 md:mb-0 opacity-0 animate-[fadeIn_0.6s_ease-out_0.6s_forwards]">
                <img src="/logo.jpg" alt="Kings Pet Hospital" className="h-8 w-8 rounded-md shadow-md ring-2 ring-white/10" />
                <p className="text-gray-400 text-sm">© 2025 Kings Pet Hospital. All rights reserved.</p>
              </div>
