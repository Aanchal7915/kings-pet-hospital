...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_0.1s_forwards]">
            <h2 className="text-2xl font-bold text-blue-400 mb-4">Kings Pet Hospital</h2>
